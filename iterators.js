...
const logHottestDays = function (temperatures, threshhold) {
    ...
    const exceededThreshhold =hottestDays (temperatures,threshhold);
    const exceededThreshholdCel = toCelsius (exceededThreshhold);

     logger(exceededThreshholdCel);
     
     // const exceededThreshhold = temperatures.filter((temperatures) => temperatures > threshhold).map((temperatures) => (temperatures - 32) * 5/9 );
